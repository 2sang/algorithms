...
int w_case_selection(int *arr, int first_index, int last_index, int target) {
    ...
    for (int i = 0; i < mess_count; i++) {
        ...
        // subarray's size = 5
            ...
            // partitioning progress using mess' first index pointer
    ...
    // Get pivot value recursively to get median of medians
...
double avg_time_5times(int *arr, int first, int last, int target){
    ...
    for(int i = 0; i < 5; i++){
        ...
        start = clock();
        w_case_selection(arr, first, last, target);
        end = clock();
...
void w_case_selection_measurement(){
    int result[4][5];
    double time_elapsed[4][5];

    // Select '10th smallest' in input50.txt
    result[0][0] = w_case_selection(arr0, 0, 49, 10);
    ...
    result[0][1] = w_case_selection(arr0, 0, 49, 25);
    ...
    result[0][2] = w_case_selection(arr0, 0, 49, 30);
    ...
    result[1][0] = w_case_selection(arr1, 0, 499, 100);
    ...
    result[1][1] = w_case_selection(arr1, 0, 499, 250);
    ...
    result[1][2] = w_case_selection(arr1, 0, 499, 300);
    ...
    result[2][0] = w_case_selection(arr2, 0, 4999, 1000);
    ...
    result[2][1] = w_case_selection(arr2, 0, 4999, 2500);
    ...
    result[2][2] = w_case_selection(arr2, 0, 4999, 3000);
    ...
    result[3][0] = w_case_selection(arr3, 0, 9999, 1000);
    ...
    result[3][1] = w_case_selection(arr3, 0, 9999, 2500);
    ...
    result[3][2] = w_case_selection(arr3, 0, 9999, 5000);
    ...
    result[3][3] = w_case_selection(arr3, 0, 9999, 7000);
    ...
    result[3][4] = w_case_selection(arr3, 0, 9999, 9000);
